...
public class AllProductActivity extends AppCompatActivity implements ProductAdapter.onProductClick, CartAdapter.onCartClick {
    public static AllProductActivity KONTEKS;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        KONTEKS = AllProductActivity.this;
    ...
    private void get(){
        apiProduct.getProductByType(getIntent().getStringExtra("type"), (new Sesi(this).valid() ? new Sesi(this).get().getId() : "0"),getIntent().getStringExtra("slug")).enqueue(new Callback<Product>() {
            @Override
                ...
                public void onResponse(Call<SingleCart> call, Response<SingleCart> response) {
                    if(response.body().getStatus().equals("200")){
                        ...
                        if(cartData.size() > 0){
                            ...
                            lnAll.setPadding(0, 0, 0, (int) (55 * getResources().getDisplayMetrics().density + 0.5f));
                        }
                    }
                }
